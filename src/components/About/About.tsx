...
const About = () => {
  ...
  return (
    <div className="flex flex-col items-center h-screen lg:justify-center">
      ...
      <div className="flex flex-col py-4 px-2 w-max ring-2 ring-teal-400 transition-all duration-200 ease-in-out lg:py-8 lg:px-8 lg:mt-0 animate-slide-in-from-bottom mt-[90px] max-h-[calc(100dvh-170px)] max-w-[90vw] backdrop-blur-md lg:hover:shadow-[10px_10px_#1f2937,20px_20px_black]">
