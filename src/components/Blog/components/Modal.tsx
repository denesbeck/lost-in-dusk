...
const Modal = ({ children, close }: ModalProps) => {
  ...
  return (
    <DarkLayout>
      <div
        ref={ref}
        className="flex flex-col px-2 w-max h-full lg:px-4 lg:pb-2 lg:ring-2 ring-primary animate-slide-in-from-bottom bg-root/50 max-w-[100dvw] font-[DepartureMono] backdrop-blur-md lg:h-[90dvh] lg:max-w-[90dvw]"
      >
