...
const BlogCard = ({ id, title, description, date }: BlogEntry) => (
  <button
    ...
    className="group relative w-[20rem] max-w-[75vw] animate-textFocus cursor-pointer space-y-2 rounded-md px-6 py-4 ring-2 ring-teal-500 ring-offset-gray-900 transition-all duration-200 ease-in-out hover:ring-offset-4 active:ring-slate-200"
  >
