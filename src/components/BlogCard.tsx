  ...
  return (
    <>
      <button
        ...
        className="group relative flex h-auto w-[20rem] min-w-[16rem] max-w-[75vw] animate-textFocus cursor-pointer flex-col space-y-2 rounded-md px-6 py-3 ring-2 ring-teal-400 ring-offset-gray-900 transition-all duration-200 ease-in-out hover:ring-offset-4 active:ring-slate-200"
      >
