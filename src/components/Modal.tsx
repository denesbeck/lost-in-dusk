...
const Modal = ({ children, close }: ModalProps) => {
  ...
  return (
    <DarkLayout>
      <div
        ref={ref}
        className="flex flex-col w-max h-full ring-teal-500 lg:px-4 lg:pb-8 lg:ring-2 max-w-[90vw] animate-slideInFromBottom font-[DepartureMono] lg:h-[90vh] dark:text-slate-200"
      >
