...
const Modal = ({ children, close }: ModalProps) => {
  ...
  return (
    <DarkLayout>
      <div
        ref={ref}
        className="flex flex-col w-max h-full ring-teal-500 lg:px-4 lg:pb-8 lg:ring-2 animate-slide-in-from-bottom max-w-[90vw] font-[DepartureMono] lg:h-[90vh] dark:text-slate-200"
      >
