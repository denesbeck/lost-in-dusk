  ...
  return (
    <div className="flex flex-col justify-center items-center h-screen">
      <div className="relative group">
        ...
        <div className="grid overflow-auto relative p-6 ring-2 ring-offset-gray-900 transition-all duration-200 ease-in-out hover:ring-offset-2 max-h-[calc(100vh-170px)] max-w-[90vw] gap-[1rem] ring-slate-800 backdrop-blur-md hover:ring-slate-500">
